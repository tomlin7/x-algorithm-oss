...
export default async function Home() {
    ...
    try {
        ...
        tweets = response.scoredPosts.map(post => ({
            ...
            content: `Simulated Tweet #${post.tweetId.toString().slice(-4)}.\n\nThis content is generated by the simulation mode of x-algorithm. The ranking score is ${post.score.toFixed(4)}.`,
            timestamp: "1h",
            stats: {
